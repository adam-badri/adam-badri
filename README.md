 ...
 <!-- About -->
  ...
  <div style="margin-bottom: 24px;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 18px; align-items: center;">
      ...
      <h3 style="margin-top: 10px; margin-bottom: 10px; color: #f9fafb;">💻 Security</h2>
      ...
      <div style="display:flex;flex-direction:column;align-items:center;width:80px;">
        <span style="font-size:32px;line-height:1;">🕷️</span>
        <span style="margin-top: 6px; font-size: 0.75rem; color: #e5e7eb;">SpiderFoot</span>
      </div>
      <div style="display:flex;flex-direction:column;align-items:center;width:80px;">
        <span style="font-size:32px;line-height:1;">🇷</span>
        <span style="margin-top: 6px; font-size: 0.75rem; color: #e5e7eb;">Recon-ng</span>
      </div>
    </div>
  </div>
  ...
  <!-- ML / Data -->
  <div style="margin-bottom: 24px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 10px; color: #f9fafb;">🤖 ML &amp; Data</h2>
    <p style="font-size: 0.9rem; color: #9ca3af; margin-bottom: 10px;">
      Libraries and frameworks I use for machine learning and data analysis:
    </p>
    <div style="display: flex; flex-wrap: wrap; gap: 18px; align-items: center;">
      <!-- PyTorch -->
      <div style="display:flex;flex-direction:column;align-items:center;width:80px;">
