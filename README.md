...
Email: mohamed.adam.badri@gmail.com


## 🚀 About Me

I'm a computer science student at the Technical University of Berlin, focused on **cybersecurity**, **ethical hacking**, and **machine learning**.  
I'm currently training as an **ethical hacker** (offensive security, CTFs, and penetration testing labs) while strengthening my foundations in algorithms and systems.

- Expanding my understanding of cyber security alongside my CS studies.  
- Building tools like port scanners, packet sniffers, and hash crackers to learn security from the ground up.  
- Experimenting with ML models for malware classification, phishing URL detection, and anomaly detection.  
- Using GitHub as a portfolio to showcase real, hands-on projects and my learning journey.  

---

## 🎓 Education & Qualifications

- **B.Sc. Computer Science** – TU Berlin (ongoing)  
- **DSH-2** – German language certificate, TH Wildau  
- **High School Graduation (Technology section, excellent)** – Lycée Pilote des Élites de Nabeul  
- **1er DAN Karate Shotokan** – Tunisian Federation of Karate  
...
<p align="left">
  <img src="https://img.icons8.com/emoji/48/satellite-emoji.png" width="48" height="48" /> nmap &nbsp;&nbsp;
...
- **Soft skills:** brilliant coder, team player, level-headed, fast learner, strong communicator  
...
- **Vice-President – Club GmcX Informatique** (Nabeul)  
- **Pianist – Sammai Conservatory Orchestra** (Jazz, Blues, Fusion)  
- **Guitarist** (live & studio performer)  
- **Karate 1er DAN Shotokan**  
...
[LinkedIn – Mohamed Adam Badri](https://www.linkedin.com/in/mohamed-adam-badri/)
